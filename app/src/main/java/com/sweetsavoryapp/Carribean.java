...
public class Carribean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Carribean");
        ...
        rv.setBackgroundResource(R.drawable.menucaribbean);
      ...
      /*  TextView tv = new TextView(this);
        ...
        tv.setTextSize(50);
        *///ll.addView(tv);
        for (Map.Entry<String, HashMap<String, HashMap<String, String>>> all : foodList.Carribean.entrySet()) {
