...
public class Hispanic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Hispanic");
      ...
      /*  TextView tv = new TextView(this);
        ...
        tv.setTextSize(50);
        *///ll.addView(tv);
        for (Map.Entry<String, HashMap<String, HashMap<String, String>>> all : foodList.Hispanic.entrySet()) {
