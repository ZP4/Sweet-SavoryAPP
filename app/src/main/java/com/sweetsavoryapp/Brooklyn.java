...
public class Brooklyn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv.setBackgroundResource(R.drawable.menubrooklyn);
      ...
      /*  TextView tv = new TextView(this);
        ...
        tv.setTextSize(50);
        *///ll.addView(tv);
        for (Map.Entry<String, HashMap<String, HashMap<String, String>>> all : foodList.Brooklyn.entrySet()) {
